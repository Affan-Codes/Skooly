        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-lama-sky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Cameron Moroun</h1>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            ...
            <Link className="p-3 rounded-md b bg-pink-50" href="/">
              Student's Exams
            </Link>
            <Link className="p-3 rounded-md b bg-lama-sky-light" href="/">
              Student's Assignments
            </Link>
            <Link className="p-3 rounded-md b bg-lama-yellow-light" href="/">
              Student's Results
            </Link>
          </div>
        </div>
