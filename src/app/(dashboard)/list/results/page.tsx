...
const ResultListPage = async ({
  ...
  const renderRow = (item: ResultList) => (
    ...
    >
      ...
      <td className="hidden lg:table-cell">
        <span className={ `px-2 py-1 rounded-full text-xs font-medium ${item.type === 'exam'
  ...
  }).filter((item): item is ResultList & { studentId: string; examId: number | null; assignmentId: number | null; } => item !== null);;
